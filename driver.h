...
public:
    ...
    unsigned long operator()(const string& key); //hash function from string to unsigned long
    //to be implemented
...
public:
    ...
    // Postcondition: All the words in the dictionary file have been read in and processed.
    void readAndProcess();
